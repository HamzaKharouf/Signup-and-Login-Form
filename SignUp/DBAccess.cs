...
namespace SignUp
{
    class DBAccess
    {
        ...
        private static string strConnString = "Data Source=LAPTOP-9H5METO7\\SQLEXPRESS;Initial Catalog=SocialNetwork;Integrated Security=True;Trust Server Certificate=True";
